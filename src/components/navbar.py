...
def render_navbar(theme: str = "dark") -> None:
    ...
    .tripai-navbar-logo-text {
      display: flex;
      flex-direction: column;
    }
    .tripai-navbar-logo-title {
      font-size: 20px;
      font-weight: 800;
    ...
    .tripai-navbar-logo-sub {
      font-size: 10px;
      color: #94A3B8;
      font-weight: 500;
      letter-spacing: 0.3px;
    }
    .tripai-navbar-actions {
      display: flex;
      align-items: center;
      gap: 8px;
    }
    ...
    .tripai-nav-btn:hover {
      transform: scale(1.12) translateY(-2px);
    }
    .tripai-nav-btn.li:hover {
    ...
    <nav class="tripai-navbar">
      <a class="tripai-navbar-logo" href="#">
        <span style="font-size:28px;line-height:1;">✈️</span>
        <div class="tripai-navbar-logo-text">
          <span class="tripai-navbar-logo-title">TripAI</span>
          <span class="tripai-navbar-logo-sub">&#9829; Love with Travel</span>
        </div>
      </a>
      <div class="tripai-navbar-actions">
        <a class="tripai-nav-btn li" href="https://www.linkedin.com/feed/update/urn:li:activity:7409296852480606208/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
        ...
        <a class="tripai-nav-btn gh" href="https://github.com/Srujanaaddanki/TravelTripBudgetPrediction" target="_blank" rel="noopener noreferrer" title="GitHub">
        ...
        <a class="tripai-nav-btn pt" href="https://github.com/Srujanaaddanki/TravelTripBudgetPrediction" target="_blank" rel="noopener noreferrer" title="Portfolio">
