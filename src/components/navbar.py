    ...
    <nav class="tripai-navbar">
      ...
      <a class="navbar-logo" href="#">
        ...
        <div class="navbar-logo-text">
          <span class="navbar-logo-title">TripAI</span>
          <span class="navbar-logo-sub">♥ Love with Travel</span>
        </div>
      </a>
      ...
      <div class="navbar-actions">
        <!-- LinkedIn -->
        <a class="nav-social-btn nav-linkedin"
        ...
        <!-- GitHub -->
        <a class="nav-social-btn nav-github"
        ...
        <!-- Portfolio / Globe -->
        <a class="nav-social-btn nav-portfolio"
           href="https://github.com/Srujanaaddanki/TravelTripBudgetPrediction"
           target="_blank"
           rel="noopener noreferrer"
           title="Portfolio">
